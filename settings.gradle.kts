...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("sqldelight-driver-native", "com.squareup.sqldelight:native-driver:$sqlDelVersion")
            library("sqldelight-driver-android", "com.squareup.sqldelight:android-driver:$sqlDelVersion")
        }
    }
}
